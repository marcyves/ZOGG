...
$lang = array_merge($lang,array(
	...
	"ACCOUNT_SPECIFY_TEAM"			=> "Please enter your team before you can take a role",
	...
	"ACCOUNT_ROLE_UPDATED"			=> "%m1%'s role changed to %m2%",
	"ACCOUNT_TEAM_UPDATED"			=> "%m1%'s team changed to %m2%",
	"ACCOUNT_GROUP_UPDATED"			=> "%m1%'s group changed to %m2%",
	...
	"ACCOUNT_ROLE_UNAVAILABLE"		=> "This role is already in use in your team",
